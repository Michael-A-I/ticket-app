...
function AnswerComments(props) {
  ...
  const handleCommentSubmit = async event => {
    ...
    try {
      ...
      /* refresh answer comments view */
      // props.getAnswerComments(props.postID)
      /* create a copy fo answer comments state prev 
         find the particular answer comments
          
      */
      // console.log("POST ID" + props.postId)
      console.log("props.setPostAnswerComments([])")
      props.setPostAnswerComments([])
    } catch (error) {
      return error
    }
  }
